...
const translations = {
  en: {
    ...
    'exp-imejr-li1':     'Led a team of over 25 people, managing projects, client interaction, member assignments, as well as mentoring junior members.',
    'exp-imejr-li6':     'Management of the biggest and most important project in the history of the junior company, a collaboration between IME Jr, Poli Jr, and ConectCar regarding data prediction.',
    'exp-imejr-role2':   'Human Resources Director',
    'exp-imejr-period2': 'Jan 2023 – Jul 2023',
    'exp-imejr-li2':     'Oversaw recruitment, onboarding, and people-management processes for the entirety of the junior company.',
    'exp-imejr-li5':     'Also helped to establish IMEnsina, a Low-income College Prep Course funded by IME Jr.',
    'exp-imejr-role3':   'Data & Computing Team Member',
    'exp-imejr-period3': 'May 2022 – Jan 2023',
    'exp-imejr-li3':     'Delivered data analysis and statistical consulting projects for external clients, as well as worked with UX-UI for Website Planning to establish an internal project portfolio.',
    'exp-imejr-li4':     'Handled a partnership project between IME Jr and EPEP USP, regarding the voting intentions among students & institutions on the 2022 Brazilian Presidential Election.',
  ...
  pt: {
    ...
    'exp-imejr-period1': 'Jul 2023 – Jan 2024',
    'exp-imejr-li1':     'Liderei uma equipe de mais de 25 pessoas, gerenciando projetos, interação com clientes, atribuição de membros e orientação de membros juniores.',
    ...
    'exp-imejr-li3':     'Realizei projetos de análise de dados e consultoria estatística para clientes externos, bem como trabalhei com UX-UI para Planejamento de Websites a fim de estabelecer um portfólio interno de projetos.',
    'exp-imejr-li4':     'Gerenciei um projeto de parceria entre IME Jr e EPEP USP sobre as intenções de voto de estudantes e instituições nas Eleições Presidenciais Brasileiras de 2022.',
