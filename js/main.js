...
const translations = {
  ...
  pt: {
    ...
    'exp-imejr-period1': 'Jul 2023 – Jan 2024',
    'exp-imejr-li1':     'Liderou uma equipe de mais de 25 pessoas, gerenciando projetos, interação com clientes, atribuição de membros, e orientação de membros juniores.',
    'exp-imejr-li6':     'Gerenciou o maior e mais importante projeto da história da empresa júnior, uma colaboração entre IME Jr, Poli Jr e ConectCar sobre predição de dados.',
    'exp-imejr-role2':   'Diretor de Recursos Humanos',
    'exp-imejr-period2': 'Jan 2023 – Jul 2023',
    'exp-imejr-li2':     'Supervisionou recrutamento, integração e gestão de pessoas para a totalidade da empresa júnior.',
